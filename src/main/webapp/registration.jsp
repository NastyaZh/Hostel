...
<div id="page-content-wrapper">
    ...
    <form action="${pageContext.request.contextPath}/controller" method="post">
        <table>
            <tr>
                <td>${name}</td>
                <td><input name="name" required pattern="^[a-zA-Zа-яА-Я-]{2,15}$"></td>
            </tr>
            <tr>
                <td>${surname}</td>
                <td><input name="surname" required pattern="^[a-zA-Zа-яА-Я-]{2,15}$"></td>
            </tr>
            <tr>
                <td>${login}</td>
                <td><input name="login" required pattern="^[a-zA-Z0-9_]{3,10}$"></td>
            ...
            <tr>
                ...
                <td><input type="password" style="width: 171px; height: 17px; padding-left: 0px" name="password"
                           required pattern="[a-zA-Zа-яА-Я0-9-]{8,14}"></td>
            </tr>
            <tr>
                <td>${email}</td>
                <td><input name="email" required pattern="^(\S+)@([a-z0-9-]+)(\.)([a-z]{2,4})(\.?)([a-z]{0,4})+$"></td>
            </tr>
            <tr>
                <td>${number}</td>
                <td><input name="number" required pattern="^+[0-9]{6,10}$"></td>
            </tr>
        </table>
