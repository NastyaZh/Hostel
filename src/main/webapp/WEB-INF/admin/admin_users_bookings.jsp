...
<div class="pagination">
    <c:if test="${requestScope.page.currentPage gt 1}">
        <a href="${pageContext.request.contextPath}/admin/admin_users_bookings?page=1&name=${param.name}"><<</a>&#8195;
        <a href="${pageContext.request.contextPath}/admin/admin_users_bookings?page=${requestScope.page.currentPage - 1}&name=${param.name}"><</a>&#8195;
    </c:if>
    ...
    <c:if test="${requestScope.page.currentPage lt requestScope.page.numberOfPages}">
        <a href="${pageContext.request.contextPath}/admin/admin_users_bookings?page=${requestScope.page.currentPage + 1}&name=${param.name}">></a>&#8195;
        <a href="${pageContext.request.contextPath}/admin/admin_users_bookings?page=${requestScope.page.numberOfPages}&name=${param.name}">>></a>
    </c:if>
</div>
</div>
</body>
